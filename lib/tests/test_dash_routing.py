...
class TestDashShellRoutes(unittest.TestCase):
    ...
    def test_optimize_route_layout_includes_overlay(self):
        ...
        self.assertIn('data-overlay', layout_str)
        self.assertIn('open-optimizer-button', layout_str)
        self.assertIn('open-data-button', layout_str)
        self.assertIn('open-data-from-optimizer', layout_str)
        self.assertNotIn('open-optimizer-from-teaser', layout_str)
        self.assertNotIn('tab-optimizer', layout_str)
        self.assertNotIn('panel-optimizer', layout_str)
        self.assertNotIn('tab-data', layout_str)
        self.assertNotIn('panel-data', layout_str)
        self.assertIn('run-optimization-btn', layout_str)
        self.assertIn('run-optimization-rail-btn', layout_str)
        self.assertIn('optimizer-workflow-steps', layout_str)
        ...
        self.assertIn('validate-regimes-btn', layout_str)
        self.assertIn('optimizer-regimes-panel', layout_str)
        self.assertIn('optimizer-regimes-interval', layout_str)
