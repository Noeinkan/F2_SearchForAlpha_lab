...
from .data_overlay import _create_data_overlay
...
def create_dashboard_layout(theme: dict, bootstrap: BootstrapSnapshot | None = None) -> html.Div:
    ...
    content = html.Div([
        ...
        dcc.Store(id='grid-results-store', data=None),
        ...
        # Phone nav scrim — closes either drawer when tapped (≤900px).
        html.Button(
            id='mobile-nav-scrim',
            n_clicks=0,
        ...
        _create_data_overlay(styles, theme),
