...
def _build_briefing(cfg: dict) -> dict:
    ...
    loop = [
        ...
        "3b:grid-search --params k1,k2 --max-combos N -> capped cartesian (optional)",
    ...
    return {
        ...
        **({"target": target, "window": win_key,
        ...
        "syntax": {
            ...
            "grid-search": "sfa grid-search --name NAME --from YYYY-MM-DD --to YYYY-MM-DD --params k1,k2 [--include-execution] --max-combos 250 --json",
